...
- **v7.1 VM Hot-Path Performance Optimization** — Phases 75-82 (active)
...
### v7.1 VM Hot-Path Performance Optimization (Phases 75-79)

- [x] **Phase 75: Baseline, Build Config, and Inline Annotations** — Establish release-mode baseline; compiler flags, FxHashMap, and inline annotations (completed 2026-03-22)
- [x] **Phase 76: Zero-Allocation Call Convention** — Eliminate intermediate Vec in all call instruction argument passing (completed 2026-03-22)
- [x] **Phase 77: Frame Register Pool** — Free-list reuse of deallocated register Vecs across calls (completed 2026-03-22)
- [x] **Phase 78: Inner Dispatch Loop** — Batched execution amortizing per-instruction scheduler overhead (completed 2026-03-22)
- [x] **Phase 79: Copy-Semantic Value Enum** — Move InlineStruct fields to heap, derive Copy on Value (completed 2026-03-22)
- [x] **Phase 80: Clone Cleanup and Micro-Optimizations** — Remove residual .clone() on Copy Value, unsafe register access, micro-opts (completed 2026-03-22)
- [x] **Phase 81: Profile-Guided Optimization Build** — PGO pipeline to close VERIFY-04 (<30s fib(40)) (completed 2026-03-22)
- [x] **Phase 82: Nyquist Validation Finalization** — Finalize VALIDATION.md for phases 75-79 (completed 2026-03-22)

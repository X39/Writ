...
extern_decl    = 'extern' ( fn_sig ';' | component_decl ) ;

const_decl     = 'const' IDENT ':' type '=' expr ';' ;
global_decl    = 'global' 'mut' IDENT ':' type '=' expr ';' ;

/* Construction expression — works for both structs (inline, no heap) and classes (GC heap) */
...
/* Expressions (simplified — see Section 1.18.1 for full precedence) */
...
unary_expr     = ( '-' | '!' | 'try' ) expr ;
binary_expr    = expr BINARY_OP expr ;    /* see Section 1.18.1 for operators */
typeof_expr    = 'typeof' '(' expr ')' ; /* static type query — see Section 1.28.2 */

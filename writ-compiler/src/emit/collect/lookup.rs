...
use crate::ast::Ast;
use crate::ast::decl::{
    AstAttribute, AstClassDecl, AstComponentDecl, AstConstDecl, AstContractDecl, AstDecl,
    AstEntityDecl, AstEnumDecl, AstExternDecl, AstFnDecl, AstFnSig, AstGlobalDecl, AstImplDecl,
    AstStructDecl,
};
    ...
    for (file_id, ast) in asts {
        ...
        for decl in &ast.items {
            match decl {
                ...
                AstDecl::Extern(AstExternDecl::Component(_, c))

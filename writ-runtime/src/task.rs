...
pub enum SuspendReason {
    ...
    Breakpoint { module_idx: usize, method_idx: u32, pc: u32, line: u32, col: u16 },
    /// Suspended after a debug step completed.
    DebugStep { mode: crate::host::DebugAction, module_idx: usize, method_idx: u32, pc: u32, line: u32, col: u16 },
...
mod tests {
    ...
    fn suspend_reason_breakpoint_can_be_constructed() {
        let reason = SuspendReason::Breakpoint { module_idx: 2, method_idx: 1, pc: 10, line: 5, col: 3 };
        match reason {
            SuspendReason::Breakpoint { module_idx: 2, method_idx: 1, pc: 10, line: 5, col: 3 } => {}
            _ => panic!("unexpected variant"),
        }
    }
    ...
    fn suspend_reason_debug_step_can_be_constructed() {
        ...
        match reason {
            SuspendReason::DebugStep { mode: DebugAction::StepOver, module_idx: 3, method_idx: 2, .. } => {}
            _ => panic!("unexpected variant"),
        }
    }
